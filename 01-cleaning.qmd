...
#### 4.1.2 Isolating fifth batch

Isolation data from "unhoused_5" to geocode.

```{r}
unhoused_to_geocode <- unhoused_reformatted |> 
...
```{r}
unhoused_to_geocode |>
  write_csv("data-processed/unhoused_to_geocode.csv")
```
